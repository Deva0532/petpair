        ...
        <div className="mode-switcher-modal bg-white rounded-[2rem] shadow-2xl px-8 pt-8 pb-10 max-w-lg w-full transform transition-all relative overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-3 relative z-10">
            ...
            <button
              ...
              className="group flex flex-col items-center text-center p-4 bg-gray-50/80 hover:bg-violet-50 border border-gray-100 hover:border-violet-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              className="group flex flex-col items-center text-center p-4 bg-gray-50/80 hover:bg-rose-50 border border-gray-100 hover:border-rose-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              className="group flex flex-col items-center text-center p-4 bg-gray-50/80 hover:bg-emerald-50 border border-gray-100 hover:border-emerald-200 rounded-2xl transition-all duration-300 hover:shadow-md hover:-translate-y-0.5"
            >
