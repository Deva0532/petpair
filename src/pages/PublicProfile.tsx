...
export const PublicProfile: React.FC = () => {
    ...
    const theme = isAdmin
      ? {
          cardGradient: 'from-cyan-50 via-blue-50/80 to-sky-50/60',
          cardBorder: 'border-cyan-200/50', cardShadow: 'shadow-cyan-900/5',
          ...
          tagBg: 'bg-white/60 border-cyan-100/50', tagIcon: 'text-cyan-500', tagText: 'text-cyan-700/80',
          bioColor: 'text-cyan-900/60',
          statBg: 'bg-white/80 border-cyan-100 shadow-cyan-100/50',
          ...
          backBtn: 'bg-cyan-100/80 text-cyan-700 border-cyan-200/60 hover:bg-cyan-200/80',
          pawBox: 'bg-cyan-100 border-cyan-200 text-cyan-700 shadow-cyan-100/50',
        }
      : isKennel
      ? {
          cardGradient: 'from-amber-50 via-orange-50/80 to-rose-50/60',
          cardBorder: 'border-amber-200/50', cardShadow: 'shadow-amber-900/5',
          ...
          tagBg: 'bg-white/60 border-amber-100/50', tagIcon: 'text-amber-500', tagText: 'text-amber-700/80',
          bioColor: 'text-amber-900/60',
          statBg: 'bg-white/80 border-amber-100/60',
          ...
          backBtn: 'bg-amber-100/80 text-amber-700 border-amber-200/60 hover:bg-amber-200/80',
          pawBox: 'bg-amber-100 border-amber-200 text-amber-700 shadow-amber-100/50',
        }
      : {
          cardGradient: 'from-violet-50 via-fuchsia-50/80 to-purple-50/60',
          cardBorder: 'border-violet-200/50', cardShadow: 'shadow-violet-900/5',
          ...
          nameClass: 'bg-gradient-to-r from-violet-700 to-fuchsia-600 bg-clip-text text-transparent',
          tagBg: 'bg-white/60 border-slate-200/50', tagIcon: 'text-violet-500', tagText: 'text-slate-500',
          bioColor: 'text-slate-600',
          statBg: 'bg-white/80 border-violet-100 shadow-violet-100/50',
          ...
          backBtn: 'bg-violet-100/80 text-violet-700 border-violet-200/60 hover:bg-violet-200/80',
          pawBox: 'bg-violet-100 border-violet-200 text-violet-600 shadow-violet-100/50',
        };
    ...
    return (
        <div className="min-h-screen bg-slate-50 pb-20 overflow-x-hidden font-sans">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 md:pt-10">
                <button
                    onClick={() => navigate(-1)}
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl backdrop-blur-md border transition-all font-semibold text-sm w-fit mb-4 shadow-sm group ${theme.backBtn}`}
                >
                ...
                <div className={`bg-gradient-to-br ${theme.cardGradient} backdrop-blur-2xl border ${theme.cardBorder} rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 shadow-2xl ${theme.cardShadow} flex flex-col md:flex-row gap-6 md:gap-10 relative overflow-hidden`}>
                    ...
                    <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-gradient-to-tr from-white/30 to-transparent rounded-full blur-[60px] translate-y-1/3 -translate-x-1/4 pointer-events-none"></div>
                    ...
                    {/* Stats */}
                    <div className="flex flex-row md:flex-col justify-center gap-3 border-t md:border-t-0 md:border-l border-slate-200/40 pt-5 md:pt-0 md:pl-8 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                        <div className={`${theme.statBg} rounded-2xl p-4 flex-1 md:flex-none flex flex-col items-center justify-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all`}>
                            {seller.reviewCount > 0 ? (
                                ...
                                <>
                                    <div className="w-9 h-9 bg-white/60 rounded-full flex items-center justify-center mb-1.5 text-slate-400">
            ...
            {/* Seller's Pets Section - Hidden for admins */}
            {!isAdmin && (
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
                <div className="flex items-center justify-between mb-8 md:mb-10">
                    <h2 className={`text-2xl md:text-3xl font-extrabold flex items-center gap-3 ${isKennel ? 'bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent' : 'bg-gradient-to-r from-violet-700 to-fuchsia-600 bg-clip-text text-transparent'}`}>
                        <div className={`w-10 h-10 rounded-xl ${theme.pawBox} flex items-center justify-center text-lg`}>
                            🐾
                        </div>
